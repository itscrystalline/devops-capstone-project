...
cluster: ## Create a Kubernetes cluster
	...
	k3d cluster create --k3s-arg '--kubelet-arg=feature-gates=KubeletInUserNamespace=true@server:*' --registry-create cluster-registry:0.0.0.0:32000 --port '8080:80@loadbalancer'
